...
export function Cart() {
  const { cart, total, addItemCart, removeItemCart} = useContext(CartConstext);
      ...
      {cart.map((item) => (
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            className="bg-slate-600 rounded px-2 text-wgite font-medium flex items-center justify-center">
              -
            </button>
            {item.amount}
            <button 
